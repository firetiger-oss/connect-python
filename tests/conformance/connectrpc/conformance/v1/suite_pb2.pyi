...
class TestSuite(_message.Message):
    ...
    def __init__(
        self,
        name: str | None = ...,
        mode: TestSuite.TestMode | str | None = ...,
        test_cases: _Iterable[TestCase | _Mapping] | None = ...,
        relevant_protocols: _Iterable[_config_pb2.Protocol | str] | None = ...,
        relevant_http_versions: _Iterable[_config_pb2.HTTPVersion | str] | None = ...,
        relevant_codecs: _Iterable[_config_pb2.Codec | str] | None = ...,
        relevant_compressions: _Iterable[_config_pb2.Compression | str] | None = ...,
        connect_version_mode: TestSuite.ConnectVersionMode | str | None = ...,
        relies_on_tls: bool = ...,
        relies_on_tls_client_certs: bool = ...,
        relies_on_connect_get: bool = ...,
        relies_on_message_receive_limit: bool = ...,
...
class TestCase(_message.Message):
    ...
    class ExpandedSize(_message.Message):
        ...
        def __init__(self, size_relative_to_limit: int | None = ...) -> None: ...
    ...
    def __init__(
        self,
        request: _client_compat_pb2.ClientCompatRequest | _Mapping | None = ...,
        expand_requests: _Iterable[TestCase.ExpandedSize | _Mapping] | None = ...,
        expected_response: _client_compat_pb2.ClientResponseResult | _Mapping | None = ...,
        other_allowed_error_codes: _Iterable[_config_pb2.Code | str] | None = ...,
    ) -> None: ...
