...
class ConformanceServiceClient:
    ...
    async def unary(self, req: connectrpc.conformance.v1.service_pb2.UnaryRequest, extra_headers: HeaderInput | None=None) -> connectrpc.conformance.v1.service_pb2.UnaryResponse:
    ...
    def server_stream(
        self, req: connectrpc.conformance.v1.service_pb2.ServerStreamRequest, extra_headers: HeaderInput | None=None
    ...
    async def client_stream(
        self, reqs: StreamInput[connectrpc.conformance.v1.service_pb2.ClientStreamRequest], extra_headers: HeaderInput | None=None
    ...
    def bidi_stream(
        self, reqs: StreamInput[connectrpc.conformance.v1.service_pb2.BidiStreamRequest], extra_headers: HeaderInput | None=None
    ...
    async def unimplemented(self, req: connectrpc.conformance.v1.service_pb2.UnimplementedRequest, extra_headers: HeaderInput | None=None) -> connectrpc.conformance.v1.service_pb2.UnimplementedResponse:
    ...
    async def idempotent_unary(self, req: connectrpc.conformance.v1.service_pb2.IdempotentUnaryRequest, extra_headers: HeaderInput | None=None) -> connectrpc.conformance.v1.service_pb2.IdempotentUnaryResponse:
