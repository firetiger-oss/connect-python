...
# Run code generator integration tests
generator-test:
...
# Run all checks (format, check, mypy, test, integration-test, generator-test)
all: format check mypy test integration-test generator-test